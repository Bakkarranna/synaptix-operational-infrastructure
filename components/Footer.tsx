          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 lg:col-span-2">
            <div>
              ...
              <ul className="space-y-3">
                  ...
                  <li><a href="/ai-tools" onClick={(e) => handleLinkClick(e, '/ai-tools')} className="text-gray-600 dark:text-white/60 hover:text-gray-800 dark:hover:text-white transition-colors text-sm">Free AI Business Tools</a></li>
              </ul>
            </div>
