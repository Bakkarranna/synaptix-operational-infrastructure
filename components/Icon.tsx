...
export const MediumIcon: React.FC<IconProps> = (props) => (<svg {...props} viewBox="0 0 24 24" fill="currentColor"><path d="M7.4,6H16.6C18.6,6,19,6.5,19,8.2V15.8C19,17.5,18.6,18,16.6,18H7.4C5.4,18,5,17.5,5,15.8V8.2C5,6.5,5.4,6,7.4,6M12.2,7.5H11.5V16.5H12.2V7.5M8.5,7.5H7.7V16.5H8.5V7.5M16.2,7.5H15.5V16.5H16.2V7.5M10.1,7.5H9.4V16.5H10.1V7.5M14.2,7.5H13.5V16.5H14.2V7.5Z" /></svg>);
