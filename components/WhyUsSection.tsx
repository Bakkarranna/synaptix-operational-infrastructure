      ...
      <div className="container mx-auto px-6">
        ...
        >
          <table className="w-full min-w-[600px]">
            <thead>
              <tr>
                <th className="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-white/40 w-1/4" />
                <th className="px-6 py-4 text-center text-xs font-semibold uppercase tracking-wider text-white/40">Traditional Studio</th>
                <th className="px-6 py-4 text-center text-xs font-semibold uppercase tracking-wider text-white/40">Freelancer</th>
            ...
            <tbody>
              {WHY_US_ROWS.map((row, i) => (
                ...
                >
                  <td className="px-6 py-4 text-xs font-semibold text-white/50 uppercase tracking-wider whitespace-nowrap">
                    {row.label}
                  </td>
                  <td className="px-6 py-4 text-center text-sm text-white/40">{row.traditional}</td>
                  <td className="px-6 py-4 text-center text-sm text-white/40">{row.freelancer}</td>
                  <td className="px-6 py-4 text-center relative">
                    <span className="text-sm font-semibold text-white">{row.synaptix}</span>
