      ...
      <div className="container mx-auto px-6 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold font-montserrat text-white">Project Vault</h2>
          ...
          <div className="bg-gray-800 border border-white/5 rounded-xl p-8 font-mono text-sm">
            <div className="text-gray-400 mb-4 text-xs uppercase tracking-wider">Active Workflows</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div className="bg-gray-800/50 backdrop-blur border border-white/5 rounded-xl p-6">
              <div className="text-gray-400 text-xs uppercase tracking-wider mb-2">Modules Loaded</div>
            ...
            <div className="bg-gray-800/50 backdrop-blur border border-white/5 rounded-xl p-6">
              <div className="text-gray-400 text-xs uppercase tracking-wider mb-2">System Status</div>
            ...
            <div className="bg-gray-800/50 backdrop-blur border border-white/5 rounded-xl p-6">
              <div className="text-gray-400 text-xs uppercase tracking-wider mb-2">Latest Deployment</div>
          ...
          <div className="mt-8 text-center">
            <div className="inline-flex items-center gap-2 bg-gray-800/50 backdrop-blur border border-white/5 px-4 py-2 rounded-lg">
              ...
              <span className="text-gray-300 text-sm">Real-time workflow monitoring active</span>
            </div>
          </div>
        </div>
      </div>
