                            ...
                            <div className="flex justify-center items-center gap-2 mb-4 sm:mb-6">
                                {Object.keys(CURRENCIES).map(curr => (
                                    <button
                                        ...
                                        className={`px-3 py-1 text-xs font-bold rounded-full transition-colors ${currency === curr ? 'bg-primary text-white' : 'bg-white/20 dark:bg-black/20 text-gray-700 dark:text-white/70 hover:bg-white/30 dark:hover:bg-black/30'
                                            }`}
                                    >
                                        {curr}
                                    </button>
